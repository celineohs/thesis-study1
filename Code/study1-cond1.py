...
- 글로벌 문화 교류 행사는 다양한 문화를 소개하기 위한 부스를 운영하는 행사로, 귀하께서는 **외국인 유학생 챗봇의 문화와 귀하의 한국 문화를 반영한 부스안**을 기획하시면 됩니다.
...
def page_booth_idea():
    ...
    st.markdown(
        ...
        f'<p style="{_mb}">아래 창에 **부스에 반영할 한국 문화의 핵심 활동**을 적어 주세요.</p>'
...
- 귀하는 외국인 유학생 챗봇과 함께 **하나의 문화 부스**를 기획합니다. 귀하께서는 **외국인 유학생 챗봇의 문화와 귀하의 한국 문화를 반영한 부스안**을 기획하시면 됩니다.
- 토론이 끝난 뒤, 대화 기록을 바탕으로 부스안의 우수도가 평가됩니다.
